...
typedef enum FeatureWord {
    ...
    FEAT_12_0_EAX,   /* CPUID[EAX=12,ECX=0].EAX */
    FEAT_12_1_EAX,  /* CPUID[EAX=0x12,ECX=1].EAX (SGX ATTRIBUTES[31:0]) */
    FEAT_12_1_EBX,  /* CPUID[EAX=0x12,ECX=1].EBX (SGX MISCSELECT[31:0]) */
